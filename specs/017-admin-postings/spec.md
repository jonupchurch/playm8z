...
- The auto-flag ruleset (banned-phrase/external-link pattern, boosting-service keywords, new-account first-post) is a small, fixed, deterministic keyword/account-age check proportionate to this feature's own needs — not a general-purpose or learned content-moderation system, and not retroactively applied to postings created before this feature ships.
