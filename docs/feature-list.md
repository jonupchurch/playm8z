...
7. Profile + Account settings — 📝 spec + plan written (`specs/007-profile-and-account-settings/`, branch `007-profile-and-account-settings`, `playm8z - Profile.dc.html`), not yet tasked
8. Blocked Users — ✅
