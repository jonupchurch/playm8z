...
12. Notifications + Report modal — 📝 spec + plan written (`specs/012-notifications-and-report-modal/`, branch `012-notifications-and-report-modal`, `support/playm8z - Notifications & Report.dc.html`), not yet tasked
13. News feed (public) — ✅
